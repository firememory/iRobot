...
CSZB_BuyVistor::CSZB_BuyVistor(void)
{
	m_pMsg = NULL;
	m_nRowNum = 0;
...
BOOL CSZB_BuyVistor::ResultStrToTable(char *pRetStr)
{
...
// 限价买入
BOOL CSZB_BuyVistor::TestCase_1()
{
	BOOL bRet = TRUE;
	strcpy_s(m_szTrdId, "0B");
...
BOOL CSZB_BuyVistor::SendKcxpMsg(char *pCmd)
{
 ...
 *	获取以下数据
	...
	2. Capitals表
		...
		2.5 在途可用
 */
BOOL CSZB_BuyVistor::InitUserData()
{
...
BOOL CSZB_BuyVistor::UpdateUserData()
{
	_variant_t TheValue; //VARIANT数据类型
	char szTmp[100] = {0};
...
BOOL CSZB_BuyVistor::GetMatchedData()
{
...
BOOL CSZB_BuyVistor::SendMidMsg(char *pCmd)
{
