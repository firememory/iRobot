...
CSH_CROSS_ETFVistor::CSH_CROSS_ETFVistor(void)
{
	m_pMsg = NULL;
	m_nRowNum = 0;
	...
	strcpy_s(m_szServiceName, "上海跨境ETF业务");

	strcpy_s(m_szSecu_Code, "510900");
	strcpy_s(m_szSecu_Intl, "1510900");
...
BOOL CSH_CROSS_ETFVistor::Vistor()
{
	BOOL bRet = TRUE;
...
BOOL CSH_CROSS_ETFVistor::ResultStrToTable(char *pRetStr)
{
...
货币ETF 511990 买入/卖出
/************************************************************************/
BOOL CSH_CROSS_ETFVistor::TestCase_1(char *pEtf_Code, char* pTrd_Id)
{
	BOOL bRet = TRUE;
...
2.5 在途可用
*/
BOOL CSH_CROSS_ETFVistor::InitUserData()
{
...
BOOL CSH_CROSS_ETFVistor::UpdateUserData()
{
	_variant_t TheValue; //VARIANT数据类型
	char szTmp[100] = {0};
...
BOOL CSH_CROSS_ETFVistor::GetMatchedData()
{
...
BOOL CSH_CROSS_ETFVistor::ChkData()
{
	BOOL bRet = TRUE;
...
// 客户资金蓝补
BOOL CSH_CROSS_ETFVistor::SaveCapital()
{
	// 资金余额蓝补1W, 资金可用蓝补1W
...
BOOL CSH_CROSS_ETFVistor::SaveShares()
{
	// 发送数据
	char szTemp[2048] = {0};
	BOOL bRet = TRUE;
...
// 给客户存入成份股
BOOL CSH_CROSS_ETFVistor::SaveEtfSecuShares()
{
	// 发送数据
	char szTemp[2048] = {0};
	BOOL bRet = TRUE;
...
void CSH_CROSS_ETFVistor::ParseKcxpRetMsg()
{
	m_pMsg = new MID_403_ORDER_RET_MSG[m_nRowNum];
	memset(m_pMsg, 0x00, sizeof(MID_403_ORDER_RET_MSG)*m_nRowNum);
...
BOOL CSH_CROSS_ETFVistor::GetEtfSecuInfo( char *pEtfIntl )
{
	_variant_t TheValue; //VARIANT数据类型
	char szTmp[100] = {0};
...
*/
/************************************************************************/
BOOL CSH_CROSS_ETFVistor::GetEtfSecuShares(int nType)
{
	_variant_t TheValue; //VARIANT数据类型
	char szTmp[100] = {0};
...
BOOL CSH_CROSS_ETFVistor::GetEtfInfo( char *pEtfIntl )
{
	_variant_t TheValue; //VARIANT数据类型
	char szTmp[100] = {0};
