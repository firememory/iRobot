...
CSH_MONEY_ETFVistor::CSH_MONEY_ETFVistor(void)
{
	m_pMsg = NULL;
	m_nRowNum = 0;
...
BOOL CSH_MONEY_ETFVistor::Vistor()
{
	BOOL bRet = TRUE;
	...
	//ExecTestCase1(TestCase_1, "跨境ETF买入 0B", "510900", "0B");
	//ExecTestCase1(TestCase_1, "跨境ETF卖出 0S", "510900", "0S");

	//ExecTestCase1(TestCase_1, "货币ETF买入 0B", "511880", "0B");
	//ExecTestCase1(TestCase_1, "货币ETF卖出 0S", "511880", "0S");

	/*
	ExecTestCase1(TestCase_1, "普通ETF申购 7K", "510051", "7K");
	ExecTestCase1(TestCase_1, "普通ETF赎回 7L", "510051", "7L");

	ExecTestCase1(TestCase_1, "国债ETF申购 7K", "511011", "7K");
	ExecTestCase1(TestCase_1, "国债ETF赎回 7L", "511011", "7L");

	ExecTestCase1(TestCase_1, "跨境ETF申购 7V", "510901", "7V");
	ExecTestCase1(TestCase_1, "跨境ETF赎回 7W", "510901", "7W");

	ExecTestCase1(TestCase_1, "货币ETF申购 7V", "511881", "7V");
	ExecTestCase1(TestCase_1, "货币ETF赎回 7W", "511881", "7W");
	*/
	return bRet;
}

BOOL CSH_MONEY_ETFVistor::ResultStrToTable(char *pRetStr)
{
...
货币ETF 511990 买入/卖出
/************************************************************************/
BOOL CSH_MONEY_ETFVistor::TestCase_1(char *pEtf_Code, char* pTrd_Id)
{
	BOOL bRet = TRUE;
...
2.5 在途可用
*/
BOOL CSH_MONEY_ETFVistor::InitUserData()
{
...
BOOL CSH_MONEY_ETFVistor::UpdateUserData()
{
	_variant_t TheValue; //VARIANT数据类型
	char szTmp[100] = {0};
...
BOOL CSH_MONEY_ETFVistor::GetMatchedData()
{
...
BOOL CSH_MONEY_ETFVistor::ChkData()
{
	BOOL bRet = TRUE;
...
// 客户资金蓝补
BOOL CSH_MONEY_ETFVistor::SaveCapital()
{
	// 资金余额蓝补1W, 资金可用蓝补1W
...
BOOL CSH_MONEY_ETFVistor::SaveShares()
{
	// 发送数据
	char szTemp[2048] = {0};
	BOOL bRet = TRUE;
...
// 给客户存入成份股
BOOL CSH_MONEY_ETFVistor::SaveEtfSecuShares()
{
	// 发送数据
	char szTemp[2048] = {0};
	BOOL bRet = TRUE;
...
void CSH_MONEY_ETFVistor::ParseKcxpRetMsg()
{
	m_pMsg = new MID_403_ORDER_RET_MSG[m_nRowNum];
	memset(m_pMsg, 0x00, sizeof(MID_403_ORDER_RET_MSG)*m_nRowNum);
...
BOOL CSH_MONEY_ETFVistor::GetEtfSecuInfo( char *pEtfIntl )
{
	_variant_t TheValue; //VARIANT数据类型
	char szTmp[100] = {0};
...
*/
/************************************************************************/
BOOL CSH_MONEY_ETFVistor::GetEtfSecuShares(int nType)
{
	_variant_t TheValue; //VARIANT数据类型
	char szTmp[100] = {0};
...
BOOL CSH_MONEY_ETFVistor::GetEtfInfo( char *pEtfIntl )
{
	_variant_t TheValue; //VARIANT数据类型
	char szTmp[100] = {0};
