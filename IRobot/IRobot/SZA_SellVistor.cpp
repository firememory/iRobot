...
CSZA_SellVistor::CSZA_SellVistor(void)
{
	m_pMsg = NULL;
	m_nRowNum = 0;
	...
	strcpy_s(m_szServiceName, "深圳A股卖出");

	strcpy_s(m_szSecu_Code, "000006");
	strcpy_s(m_szSecu_Intl, "6");
...
BOOL CSZA_SellVistor::Vistor()
{
	...
	ExecTestCase(TestCase_4, "即时成交剩余撤销委托 2S");
	ExecTestCase(TestCase_5, "五档即时成交剩余撤销 VS");
	ExecTestCase(TestCase_6, "全额成交或撤销委托 WS");

	return bRet;
}

BOOL CSZA_SellVistor::ResultStrToTable(char *pRetStr)
{
...
BOOL CSZA_SellVistor::TestCase_1()
{
	BOOL bRet = TRUE;
	strcpy_s(m_szTrdId, "0S");
...
BOOL CSZA_SellVistor::TestCase_2()
{
	BOOL bRet = TRUE;
...
BOOL CSZA_SellVistor::TestCase_3()
{
	BOOL bRet = TRUE;
...
BOOL CSZA_SellVistor::TestCase_4()
{
	BOOL bRet = TRUE;
...
BOOL CSZA_SellVistor::TestCase_5()
{
	BOOL bRet = TRUE;
...
BOOL CSZA_SellVistor::TestCase_6()
{
	BOOL bRet = TRUE;
...
BOOL CSZA_SellVistor::SendKcxpMsg(char *pCmd)
{
 ...
 *	获取以下数据
	...
	2. Capitals表
		...
		2.5 在途可用
 */
BOOL CSZA_SellVistor::InitUserData()
{
...
BOOL CSZA_SellVistor::UpdateUserData()
{
	_variant_t TheValue; //VARIANT数据类型
	char szTmp[100] = {0};
...
BOOL CSZA_SellVistor::GetMatchedData()
{
