...
CSHLOFVistor::CSHLOFVistor(void)
{
	m_pMsg = NULL;
	m_nRowNum = 0;
	...
	strcpy_s(m_szServiceName, "上海场内基金业务");

	strcpy_s(m_szSecu_Code, "519181");
	strcpy_s(m_szSecu_Intl, "1519181");
...
BOOL CSHLOFVistor::ResultStrToTable(char *pRetStr)
{
...
BOOL CSHLOFVistor::SendKcxpMsg(char *pCmd)
{
 ...
 *	获取以下数据
	...
	2. Capitals表
		...
		2.5 在途可用
 */
BOOL CSHLOFVistor::InitUserData()
{
...
BOOL CSHLOFVistor::UpdateUserData()
{
	_variant_t TheValue; //VARIANT数据类型
	char szTmp[100] = {0};
...
BOOL CSHLOFVistor::GetOrderData()
{
...
BOOL CSHLOFVistor::SendMidMsg(char *pCmd)
{
